...
import { getItemsByID,UpdateItem } from '../services/itemServices';
 ...
 const handleUpdateItem = async (e) => {
  ...
  const getItem = async ()=>{
      ...
      console.log("Item",data.data.data.data);
        setItemName(data.data.data.data.newdata.ItemName);
        setbrandName(data.data.data.data.newdata.brandName);
        setmodel(data.data.data.data.newdata.model);
        setprice(data.data.data.data.newdata.price);
  }
            ...
            <div>
                <center>
                    ...
                    <form>
                        ...
                        <button onClick={handleUpdateItem} className="btn btn-primary" type="submit">
                        Update
                        </button>
                    </form>         
                </center>
